...
<template>
    ...
    <div id="register" class="container">
        ...
        <div class="cover">
            ...
            <div class="back">
                <img class="backImg" src="/pic/login-register/frontImg.jpg" alt="">
                <div class="text">
                ...
                <div class="signup-form">
                    ...
                    <form action="" @submit.prevent="handleSubmit">
                        <div class="input-boxes">
                            ...
                            <FormItem class="input-box" field="rePass" required :v$="v$">
                                <i class="fa fa-lock" />

                                <input id="rePass" v-model="registerData.rePass" placeholder="Repeat your password"
                                    :class="{ error: v$?.registerData.rePass.$errors.length }" type="password">
                            </FormItem>
                            ...
                            <div class="text sign-up-text">
                                Already have an account? <label for="flip-2">Login now</label>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="login-form">
                    ...
                    <form @submit.prevent="onSubmit">
                        <div class="input-boxes">
                            ...
                            <div class="text sign-up-text">
                                Don't have an account? <label for="flip-2">Sigup now</label>
                            </div>
                        </div>
                    </form>
                </div>
